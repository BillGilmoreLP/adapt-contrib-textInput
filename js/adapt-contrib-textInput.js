define(function(require) {
    ...
    var TextInput = QuestionView.extend({
        ...
        clearValidationError: function() {
            this.$(".text-input__textbox").removeClass("text-input__textbox--error");
        },

        // Use to check if the user is allowed to submit the question
        canSubmit: function() {
            var canSubmit = true;
            this.$(".text-input__textbox").each(function() {
                if ($(this).val() == "") {
                    canSubmit = false;
                }
            });
        ...
        showValidationError: function() {
            this.$(".text-input__textbox").addClass("text-input__textbox--error");
        },
        ...
        storeUserAnswer: function() {
            ...
            _.each(items, function(item, index) {
                item.userAnswer = this.$('.text-input__textbox').eq(index).val();
            }, this);
        ...
        showMarking: function() {
            ...
            _.each(this.model.get('_items'), function(item, i) {
                var $item = this.$('.text-input__item').eq(i);
        ...
        resetQuestion: function() {
            this.$('.text-input__textbox').prop('disabled', !this.model.get('_isEnabled')).val('');
        ...
        showCorrectAnswer: function() {
            ...
            if(this.model.get('_answers'))  {
                ...
                _.each(this.model.get('_items'), function(item, index) {
                    this.$(".text-input__textbox").eq(index).val(correctAnswers[index][0]);
                }, this);

            } else {
                _.each(this.model.get('_items'), function(item, index) {
                    this.$(".text-input__textbox").eq(index).val(item._answers[0]);
                }, this);
            }
        ...
        hideCorrectAnswer: function() {
            _.each(this.model.get('_items'), function(item, index) {
                this.$(".text-input__textbox").eq(index).val(item.userAnswer);
            }, this);
        },
